...
public class ResizingArrayQueue<Item> implements Iterable<Item> {
    ...
    /**
     * Returns an com.gojava6.iterator that iterates over the items in this queue in FIFO order.
     *
     * @return an com.gojava6.iterator that iterates over the items in this queue in FIFO order
     */
