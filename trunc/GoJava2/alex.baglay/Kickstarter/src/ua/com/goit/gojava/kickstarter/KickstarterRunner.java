...
public class KickstarterRunner {
	...
	public static void main(String[] arguments) {		
		...
		// Все как бы ничего, но у меня нумерация проектов и категорий начинается с 0, а потому надо поисправлять для начала везде
		// поменять нумерацию проектов тоже с 1
		// TODO потом надо реслизовать выход из меню проектов - сделаем это!
		...
		// может заказчику так он, спросить надобно TODO. А мне меньше работы
		// хороший проггер не тот что рвется в бой побыстрее нафигачить кода, хороший проггер - ленивый проггер
		// хороший код - ненаписанный код...
		
//		TODO Выберите категорию:
//			[1 - Photo, 2 - Video, 3 - Music]
//			1
//			Вы выбрали категорию: Photo
//			--------------------------------------
//			Выберите проект: [0...-1]
//			бага :)
