...
public class Categories {
	...
	public int size() {
		// простите туплю :) счетчик уже есть иногда такое случается со всеми, если нарежешь большую задачу на мелкие, то откатить 
		// 5 минут работы не жалко, но если будешь все делать большими кусками есть шанс что потом прийдется все переделывать.
		// потому большую фичу (историю) дробим на мелкие части. В каждый момент времени занимаемся чем-то одним, и не более.
		// после каждого инкремента будь то багфикс или маленькое продвижение по юзерсториез - коммит. после рефакторинга - коммит.
		// частые коммиты. Каждые 5-15 минут
		return count;
	}
