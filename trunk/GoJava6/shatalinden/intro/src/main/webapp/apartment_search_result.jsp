...
<section class="search">
  <div class="wrapper">
    <form action="GetApartmentsByCity" method="post">
...
<section class="listings">
  <div class="wrapper">
    <ul class="properties_list">
      <%
          List<Apartment> apartments = apartmentDao.pullApartmentsByCity(GetAppartmentsByCity.city);
          for (int i = 0; i < apartments.size(); i++) {
              String picture = "img/property_1.jpg";
              if (i==2 || i%2==0) picture = "img/property_2.jpg";
              if (i==3 || i%3==0) picture = "img/property_3.jpg";
      ...
      %>
        <li>
            ...
            <div class="property_details">
                <h1>
                    <a href="#"><%= apartment.getShortDescription() %></a>
                </h1>
                <h2><%= apartment.getType() %> <span class="property_size">(288ftsq)</span></h2>
            </div>
        </li>
      <%
          }
