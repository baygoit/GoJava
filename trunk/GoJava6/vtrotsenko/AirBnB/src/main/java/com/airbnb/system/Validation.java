...
import com.airbnb.user.UserType;
...
public class Validation {
    ...
    public static boolean isValidUserType(UserType userType) {
        ...
        Log.logger.warning("Validation of UserType failed!");
        return false;
    }
    ...
    public static boolean isValidName(String name) {
        ...
        if(name != null && !consistDigits(name))
            ...
            Log.logger.warning("Validation of name/surname/city failed!");
            return false;
        }
    }
    ...
    public static boolean isValidApartmentType(ApartmentType apartmentType) {
        ...
        Log.logger.warning("Validation of ApartmentType failed!");
        return false;
    }
