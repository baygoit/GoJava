...
public class QuestionTest {
	...
	public void testFindAnswerById() {
		...
		try {
			assertEquals(question.findAnswerById(2), expected);
		} catch (InterviewSimulatorException e) {
			e.getMessage();
		}
	}
	
	@Test(expected=InterviewSimulatorException.class)
	public void testFindAnswerByIdInsertWrongId() throws InterviewSimulatorException {
		final int ID = 3;
