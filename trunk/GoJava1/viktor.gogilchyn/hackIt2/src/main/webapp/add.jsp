...
<body id="main_body" >
	<div id="form_container">
		...
		<form id="form_970427" class="appnitro"  method="post" action="">
...
It's recommended to use one word, started with capotal, ex. "Joe"</small></p> 
		</li>		<li id="li_2" >
		...
		</div><p class="guidelines" id="guide_2"><small>Enter desired skills, delimitered by comma. 
Skill can contain only of ine word, all symbols should be lowercase</small></p> 
		</li>
					<li class="buttons">
			    <input type="hidden" name="form_id" value="970427" />
