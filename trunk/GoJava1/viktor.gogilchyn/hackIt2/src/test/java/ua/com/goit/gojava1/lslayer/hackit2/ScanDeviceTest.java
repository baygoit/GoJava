...
import ua.com.goit.gojava1.lslayer.hackit2.gear.Hardware;
...
public class ScanDeviceTest {
    ...
    @Test
    public void testUseOfDevice() {
        Actor actor = new HumanControlledCharacter("MegaPihar");
        actor.addSkill("scan");
        Hardware scanner = new ScanDevice("ScanMaster22000").addPurpose("scan", 100);
        ...
        result = action.execute(actor, scanner, target);
