...
public class MedicalSystem {
            ...
            if (userSelection == 1){
            	...
            	if (isHaveSpec(doctors, specSelection)){
            		...
            		for (Doctor doc: doctors){
                		if (doc.specialization.equals(specSelection)){
                			System.out.println(doc.name + " " + doc.surname);
                		}
                	}
            	} else {
    ...
    private static Doctor createDoctor(ArrayList<String> specs){
    ...
    private static String selectSpec(ArrayList<String> specs){
    ...
    private static boolean isHaveSpec(ArrayList<Doctor> doctors, String spec){
    	for(Doctor doc: doctors){
    		if(doc.specialization.equals(spec)) return true;
    	}
    	return false;
    }
