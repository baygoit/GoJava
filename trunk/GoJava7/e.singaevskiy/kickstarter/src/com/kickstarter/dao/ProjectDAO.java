...
public class ProjectDAO extends CommonDAO<Project> {
	...
	public ProjectDAO() {
		...
		addElementToDataSource(Project.newBuilder()
			.setName("Xpand Lacing System")
		...
		addElementToDataSource(Project.newBuilder()
			.setName("Draw Like a Boss : The Physical Book")
		...
		addElementToDataSource(Project.newBuilder()
			.setName("Mini Museum 2: The Second Edition")
	...
	private void addElementToDataSource(Project.Builder projectBuilder){
		...
		projectBuilder
			...
			.addFAQ(faqList.get(rnd.nextInt(faqList.size())));
		dataSource.add(projectBuilder.build());
	}
