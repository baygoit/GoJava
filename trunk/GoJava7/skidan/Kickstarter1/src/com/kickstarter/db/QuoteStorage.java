...
public class QuoteStorage {
...

	{
		...
		quotes.add("To improve is to change; to be perfect is to change often. " + " Winston_churchill");
		...
		quotes.add("Attitude is a little thing that makes a big difference. " + " Winston Churchill");
