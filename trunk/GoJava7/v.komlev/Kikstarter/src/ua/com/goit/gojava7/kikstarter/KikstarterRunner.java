...
public class KikstarterRunner {
	...
	private static List<Project> initProjects() {
		...
		project1.setDescription("A photobook of B&W photography by Bill Bytsura documenting"
				+ " the people and stories behind the AIDS activist movement between 1989–1998.");
		project1.setDetailedDescription("I’m a photographer who’s lived in NYC for over three decades. "
		...
		project1.setUrl("https://www.kickstarter.com/projects/aidsactivistproject/the-aids-activist-project-portraits-and-stories-19?ref=category_featured");

		Project project2 = new Project("Poughkeepsie", 35000, 4885, 27);
		project2.setDescription("A dying Alzheimer's patient believes he has the ability"
				+ " to travel back in time and tries to rewrite his past before time runs out.");
		project2.setDetailedDescription("Poughkeepsie is a 20-minute short film about George Dawes, "
		...
		project2.setUrl("https://www.kickstarter.com/projects/1749833744/poughkeepsie-a-short-film?ref=category_recommended");

		Project project3 = new Project("HELP BRING BACK GOOD MUSIC!", 7500, 845, 25);
		project3.setDescription("In this exciting project, we will be building a brand"
				+ " new recording studio from the ground up for everyone to enjoy!");
		project3.setDetailedDescription("THE VISION - Construct one of the best recording studios in the area where some amazing music can be created. "
		...
		project3.setUrl("https://www.kickstarter.com/projects/1285390802/help-bring-back-good-music-recording-studio-build?ref=nav_search");

		Project project4 = new Project("A Thousand Dawns: Worldcycle Story & Photobook", 15000,
				12161, 7);
		project4.setDescription("A 40,000km, 4 year journey by bicycle around the world, told through tales of adventure & photography.");
		project4.setDescription("That's right. The world. The whole globe. By bicycle.A journey full circle from London to London on two wheels. "
		...
		project4.setUrl("https://www.kickstarter.com/projects/roblutter/a-thousand-dawns-the-lifecycle-story-and-photobook?ref=category_popular");

		Project project5 = new Project("Of Woman And Earth Documentary", 10000, 4527, 5);
		project5.setDescription("A story from the roof of the world, documenting the last generation of Ladakhi nomads living in the Tibetan Plateau.");
		project5.setDetailedDescription("Set against the wild majesty of the Himalayas in the Indian province of Ladakh, "
		...
		project5.setUrl("https://www.kickstarter.com/projects/285884784/of-woman-and-earth-documentary?ref=category_featured");
