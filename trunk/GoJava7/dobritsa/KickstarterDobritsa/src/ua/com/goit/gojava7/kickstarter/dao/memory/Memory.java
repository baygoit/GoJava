...
public class Memory {
	...
	private void initCategories() {
		...
		categories.add(new Category("Dances"));
	}

	private void initProjects() {
		Project project;

		project = new Project("Shift the Grid presents Vacancy",
		...
		project = new Project("DanceProject2", "Description22", 22000, 2200, 22, "history22", "link22");
		project.setCategoryName("Dances");
		projects.add(project);

		project = new Project("DanceProject3", "Description23", 23000, 2300, 23, "history22", "link22");
		project.setCategoryName("Dances");
		projects.add(project);

		project = new Project("'Critical Mass': New solo music from Jerry Chamberlain!",
		...
		project = new Project("MusicProject2", "Description12", 12000, 1200, 12, "history12", "link12");
		project.setCategoryName("Music");
		projects.add(project);

		project = new Project("MusicProject3", "Description13", 13000, 1300, 13, "history13", "link13");
		project.setCategoryName("Music");
		projects.add(project);

		project = new Project("The Cookie Counter: vegan bakery, espresso bar, & ice cream!",
		...
		project = new Project("FoodProject2", "Description12", 12000, 1200, 12, "history12", "link12");
		project.setCategoryName("Food");
		projects.add(project);

		project = new Project("FoodProject3", "Description13", 13000, 1300, 13, "history13", "link13");
		project.setCategoryName("Food");
		projects.add(project);
	}
