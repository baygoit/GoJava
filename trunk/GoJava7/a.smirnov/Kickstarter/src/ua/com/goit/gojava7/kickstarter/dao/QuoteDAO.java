...
public class QuoteDAO extends CommonDAO<Quote> {
	...
	public QuoteDAO() {
		...
		quote2.setTitle("Government's first duty is to protect the people, not " + "run their lives.");
		quote2.setAuthor("Ronald Reagan");

		Quote quote3 = new Quote();
		quote3.setTitle("The most terrifying words in the English language are: "
