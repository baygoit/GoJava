...
public class RewardDaoMysqlImpl implements RewardDao {
	...
	public void add(Reward reward) {
		try (PreparedStatement statement = connection.prepareStatement(INSERT_REWARD)) {
	...
	public void remove(Reward reward) {
		try (PreparedStatement statement = connection.prepareStatement(DELETE_REWARD)) {
	...
	public List<Reward> getProjectsRewards(int projectId) {
		...
		try (PreparedStatement statement = connection.prepareStatement(SELECT_PROJECTS_REWARDS)) {
