...
public class RotatedArrayTest {
  ...
  public void testCase1() {
    int actual = RotatedArray.binarySearch(new int[] { 4, 5, 6, 7, 8, 9, 10,
        11, 12, 34, 57, 1, 2, 3 }, 8);
    int expected = 4;
  ...
  public void testAbsentElement() {
    int actual = RotatedArray.binarySearch(new int[] { 9, 1, 2, 3, 5, 7, 8 },
        18);
    int expected = -1;
    assertEquals(expected, actual);
    ;
  ...
  public void testCase2() {
    int actual = RotatedArray.binarySearch(
        new int[] { 41, 1, 2, 3, 5, 7, 8, 23 }, 1);
    int expected = 1;
    assertEquals(expected, actual);
    ;
  }
  ...
  public void testCase3() {
    int actual = RotatedArray.binarySearch(new int[] { 21, 1, 2, 3, 5, 7, 9,
        11, 14, 7 }, 21);
    int expected = 0;
    assertEquals(expected, actual);
    ;
  ...
  public void testCase8() {
    int actual = RotatedArray.binarySearch(new int[] {1}, 0);
    int expected = -1;
    assertEquals(expected, actual);
    ;
  }
