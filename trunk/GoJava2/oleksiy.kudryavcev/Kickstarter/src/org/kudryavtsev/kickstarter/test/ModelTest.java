...
public class ModelTest {
    ...
    public void testGetProjectsList() {
        ...
        assertEquals(
                ...
                model.getCategoriesList().get(0).getProjectsList().toString());
        assertEquals(
                ...
                model.getCategoriesList().get(1).getProjectsList().toString());
        assertEquals(
                ...
                model.getCategoriesList().get(2).getProjectsList().toString());
    }
}
