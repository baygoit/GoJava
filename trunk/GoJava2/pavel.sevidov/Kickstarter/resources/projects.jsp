        ...
        <div class="panel-body">
          ...
          <div class="row">    
            ...
            <div class="col-md-2 col-sm-3 text-center">
              <a class="story-title" href="/servlets/project?id=${project.id}"><img alt="" src="http://m.eet.com/media/1176482/2203520-kickstarter_badge_funded.png" style="width:150px;height:150px" class="img-rounded"></a>
            </div>
            <div class="col-md-10 col-sm-9">
              <a href="/servlets/project?id=${project.id}"><h3><c:out value="${project.name}"/></h3></a>
              <div class="row">
                <div class="col-xs-9">
