        ...
        <div class="panel-body">
          ...
          <div class="row">    
            ...
            <div class="col-md-2 col-sm-3 text-center">
              <a class="story-title" href="/servlets/projects?category=${category.id}"><img alt="" src="https://www.kickstarter.com/download/kickstarter-badge-funded.png" style="width:100px;height:100px" class="img-circle"></a>
            </div>
            <div class="col-md-10 col-sm-9">
              <a href="/servlets/projects?category=${category.id}"><h3><c:out value="${category.name}"/></h3></a>
              <div class="row">
                <div class="col-xs-9">
