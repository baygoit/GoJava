...
public class ProjectsController {
	...
	@RequestMapping("/projects/{categoryID}")
	public String projects(Model model, @PathVariable int categoryID) {
		model.addAttribute("projects", projectsService.findByCategory(categoryID));
		return "projects";
	}
