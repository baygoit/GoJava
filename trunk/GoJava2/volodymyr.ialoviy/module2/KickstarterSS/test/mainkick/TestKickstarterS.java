...
public class TestKickstarterS {
    ...
    public void testKickstarterS(){
		...
		assertEquals("1 category1\n2 category2\n3 category3", kickstarter.getOut().getMessages().get(1));
		assertEquals("Choice Category Number: ", kickstarter.getOut().getMessages().get(2));
		assertEquals("Your chosen category: category1, containing the following projects: ", kickstarter.getOut().getMessages().get(3));
		assertEquals("1, name1, short description1, 1 000,00 ?, 10,00 ?\n3, name3, short description3, 1 000,00 ?, 10,00 ?\n4, name4, short description4, 1 000,00 ?, 10,00 ?", kickstarter.getOut().getMessages().get(4));
		...
		assertEquals("Your chosen category: category1, containing the following projects: ", kickstarter.getOut().getMessages().get(12));
		assertEquals("1, name1, short description1, 1 000,00 ?, 10,00 ?\n3, name3, short description3, 1 000,00 ?, 10,00 ?\n4, name4, short description4, 1 000,00 ?, 10,00 ?", kickstarter.getOut().getMessages().get(13));
		...
		assertEquals("\"0\" - No thanks, I just want to help the project. \"1\" - 1$ = OUR UNDYING LOVE \"2\" - 10,00 ?$ = HEY… NICE SHIRT \"3\" - 40$ = KICKSTARTER EXCLUSIVE", kickstarter.getOut().getMessages().get(18));
    ...
    public void testPayment(){
		...
		assertEquals("projectID = 1\nprojectName: name1\nshortDescription: short description1\nfullDescription: full description1\nfoto: foto1\nlink: Link\nhowMuchNeeded = 1 000,00 ?\nhowMuchCollected = 10,00 ?\nhowMuchRemaining = 990\nfaq = [ ]", kickstarter.getOut().getMessages().get(6));
		assertEquals("Choice 333 for exit to Project list.\nChoice 555 to invest in the project:Have a question? If the info above doesn't help, you can ask the project creator directly - Choice 666:", kickstarter.getOut().getMessages().get(7));
		assertEquals("\"0\" - No thanks, I just want to help the project. \"1\" - 1$ = OUR UNDYING LOVE \"2\" - 10,00 ?$ = HEY… NICE SHIRT \"3\" - 40$ = KICKSTARTER EXCLUSIVE", kickstarter.getOut().getMessages().get(8));
		...
		assertEquals("\"0\" - No thanks, I just want to help the project. \"1\" - 1$ = OUR UNDYING LOVE \"2\" - 10,00 ?$ = HEY… NICE SHIRT \"3\" - 40$ = KICKSTARTER EXCLUSIVE", kickstarter.getOut().getMessages().get(15));
		...
		assertEquals("\"0\" - No thanks, I just want to help the project. \"1\" - 1$ = OUR UNDYING LOVE \"2\" - 10,00 ?$ = HEY… NICE SHIRT \"3\" - 40$ = KICKSTARTER EXCLUSIVE", kickstarter.getOut().getMessages().get(21));
		...
		assertEquals("Choice 333 for exit to Project list.\nChoice 555 to invest in the project:Have a question? If the info above doesn't help, you can ask the project creator directly - Choice 666:", kickstarter.getOut().getMessages().get(26));
		assertEquals("\"0\" - No thanks, I just want to help the project. \"1\" - 1$ = OUR UNDYING LOVE \"2\" - 10,00 ?$ = HEY… NICE SHIRT \"3\" - 40$ = KICKSTARTER EXCLUSIVE", kickstarter.getOut().getMessages().get(27));
    ...
    public void testBug(){
		...
		assertEquals("Your chosen category: category1, containing the following projects: ", kickstarter.getOut().getMessages().get(4));
		assertEquals("1, name1, short description1, 1 000,00 ?, 10,00 ?\n3, name3, short description3, 1 000,00 ?, 10,00 ?\n4, name4, short description4, 1 000,00 ?, 10,00 ?", kickstarter.getOut().getMessages().get(5));
		...
		assertEquals("You have entered an incorrect value or a null value, check the value you entered and try again", kickstarter.getOut().getMessages().get(9));
		assertEquals("\"0\" - No thanks, I just want to help the project. \"1\" - 1$ = OUR UNDYING LOVE \"2\" - 10,00 ?$ = HEY… NICE SHIRT \"3\" - 40$ = KICKSTARTER EXCLUSIVE", kickstarter.getOut().getMessages().get(10));
