...
public class ManualInput implements LoadingData{
    ...
    private Map<Category, List<Project>>  mappingCategoryAndProject = new HashMap<Category, List<Project>>();
    ...
    public void load(){
        ...
        List<Project> projectOfCategory = new ArrayList<Project>();
...
//        mappingCategoryAndProject.put(elementCategory, copyList);
    ...
    @Override
    public Map<Category, List<Project>> getMapping() {
