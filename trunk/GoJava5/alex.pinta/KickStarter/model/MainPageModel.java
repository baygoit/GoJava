...
public class MainPageModel {
    ...
    private Map<Category, List<Project>> mappingProjectOfCategory = new HashMap<Category, List<Project>>();
    private List<Integer> userChoice;

    public void setModelSource(Map<Category, List<Project>> mappingProjectOfCategory, List<Category> catalogCategory){
