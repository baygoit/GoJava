...
public class ProjectsTest {
    ...
    public void  shouldProjectsWenNoProjectsWithNoSameCategory() throws Exception {
        ...
        Project project1 = new Project("name1 \"Popcorn\"", 10000, 10, 10, "Interesting game");
        Project project2 = new Project("name2 \"Popcorn\"", 10000, 10, 10, "Interesting game");
    ...
    public void  shouldProjectsWenNoProjectsWithSameCategory() throws Exception {
        ...
        Project project1 = new Project("name1 \"Popcorn\"", 10000, 10, 10, "Interesting game");
        Project project2 = new Project("name2 \"Popcorn\"", 10000, 10, 10, "Interesting game");
        Project project3 = new Project("name2 \"Popcorn\"", 10000, 10, 10, "Interesting game");
