...
public class BootStrap {
	...
	public static void main(String[] args) {
        ...
        MainPageController mainPageController = ((MainPageController) configuration.getControllersConfiguration());
        Kickstarter runner = new Kickstarter(console, mainPageController);
		runner.run();
	}
