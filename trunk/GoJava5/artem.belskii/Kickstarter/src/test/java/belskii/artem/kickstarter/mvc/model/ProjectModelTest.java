...
public class ProjectModelTest {
	...
	public void testAddProject() {
		Project testProject = new Project("My test project",new Long(1), new Long(1),"28.07.2015","30.07.2015","https://www.youtube.com/watch?v=uC0pqWX3yB8", 1, "My super project!",paymentVariants);
	...
	public void getProjectFromCategory(){
		Project projectFromCategory = new Project("Project from category",new Long(1), new Long(1),"28.07.2015","30.07.2015","https://www.youtube.com/watch?v=uC0pqWX3yB8", 5, "My super project2!",paymentVariants);
