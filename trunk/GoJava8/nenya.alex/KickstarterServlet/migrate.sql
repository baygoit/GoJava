...
CREATE TABLE PROJECTS (id SERIAL PRIMARY KEY, category_id INTEGER REFERENCES Categories, name VARCHAR(50) NOT NULL UNIQUE, 
description VARCHAR(200) NOT NULL, needed_amount INTEGER NOT NULL,
days_remain INTEGER NOT NULL, history VARCHAR(500), video VARCHAR(50));
...
CREATE TABLE REWARDS (id SERIAL PRIMARY KEY, project_id INTEGER REFERENCES Projects, name VARCHAR(50) NOT NULL, amount INTEGER, description VARCHAR(200));
...
INSERT INTO Rewards (project_id, name, amount, description) VALUES (5, '100$', 100, 'Invest one hundred dollars and get bottle of water!!!');
INSERT INTO Rewards (project_id, name, amount, description) VALUES (5, '100$', 100, 'Invest one hundred dollars and get five bottles of water!!!');
INSERT INTO Rewards (project_id, name, amount, description) VALUES (5, '200$', 200, 'Invest two hundreds dollars and get two tickets to the movie!!!');
INSERT INTO Rewards (project_id, name, amount, description) VALUES (5, '200$', 200, 'Invest two hundreds dollars and get tickets to the movie for all family!!!');
INSERT INTO Rewards (project_id, name, amount, description) VALUES (5, '500$', 500, 'Invest five hundreds dollars and get a lunch for two persons in the restaurant!!!');
INSERT INTO Rewards (project_id, name, amount, description) VALUES (6, '100$', 100, 'Invest one hundred dollars and get bottle of water!!!');
INSERT INTO Rewards (project_id, name, amount, description) VALUES (6, '100$', 100, 'Invest one hundred dollars and get five bottles of water!!!');

CREATE TABLE QUESTIONS (id SERIAL PRIMARY KEY, project_id INTEGER REFERENCES Projects, name VARCHAR(500) NOT NULL);
INSERT INTO Questions (project_id, name) VALUES (1, 'Why?');
INSERT INTO Questions (project_id, name) VALUES (1, 'Who?');
INSERT INTO Questions (project_id, name) VALUES (2, 'What?');
INSERT INTO Questions (project_id, name) VALUES (2, 'Which?');
INSERT INTO Questions (project_id, name) VALUES (3, 'Is it really?');
INSERT INTO Questions (project_id, name) VALUES (3, 'Why?');
INSERT INTO Questions (project_id, name) VALUES (4, 'Who?');
INSERT INTO Questions (project_id, name) VALUES (4, 'What?');
INSERT INTO Questions (project_id, name) VALUES (5, 'Which?');
INSERT INTO Questions (project_id, name) VALUES (5, 'Is it really?');
INSERT INTO Questions (project_id, name) VALUES (6, 'Why?');
INSERT INTO Questions (project_id, name) VALUES (6, 'Who?');
INSERT INTO Questions (project_id, name) VALUES (6, 'What?');
INSERT INTO Questions (project_id, name) VALUES (6, 'Which?');
INSERT INTO Questions (project_id, name) VALUES (6, 'Is it really?');

CREATE TABLE PAYMENTS (id SERIAL PRIMARY KEY, project_id INTEGER REFERENCES Projects, amount INTEGER);
...
INSERT INTO PAYMENTS (project_id, amount) VALUES (2, 100);
INSERT INTO PAYMENTS (project_id, amount) VALUES (2, 90);
INSERT INTO PAYMENTS (project_id, amount) VALUES (3, 300);
INSERT INTO PAYMENTS (project_id, amount) VALUES (4, 125);
INSERT INTO PAYMENTS (project_id, amount) VALUES (4, 75);
INSERT INTO PAYMENTS (project_id, amount) VALUES (4, 122);
INSERT INTO PAYMENTS (project_id, amount) VALUES (4, 78);
INSERT INTO PAYMENTS (project_id, amount) VALUES (5, 350);
INSERT INTO PAYMENTS (project_id, amount) VALUES (5, 150);
INSERT INTO PAYMENTS (project_id, amount) VALUES (6, 533);
INSERT INTO PAYMENTS (project_id, amount) VALUES (6, 67);