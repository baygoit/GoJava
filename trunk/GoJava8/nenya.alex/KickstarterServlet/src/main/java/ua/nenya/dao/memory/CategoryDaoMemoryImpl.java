...
public class CategoryDaoMemoryImpl implements CategoryDao {
	...
	public void initCategories() {
		...
		categoryMusic.setName("MusicM");
		Project project1 = new Project();
		project1.setName("A new funny songM");
		...
		project2.setName("A lonly songM");
		...
		categoryFilms.setName("FilmsM");
		Project project3 = new Project();
		project3.setName("Terminator 88M");
		...
		categoryArt.setName("ArtM");
		Project project5 = new Project();
		project5.setName("Exhibition of photosM");
		...
		project6.setName("Exhibition of platesM");
