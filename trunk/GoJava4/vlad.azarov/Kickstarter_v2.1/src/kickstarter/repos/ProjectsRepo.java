...
public class ProjectsRepo implements Repo {
	...
	public ProjectsRepo() {
		...
		add(new Project(
				...
				"http://www.youtube.com/01", "Some question text", categoriesRepo
		...
		add(new Project("HYDAWAY",
				...
				"Some question text", categoriesRepo.getCategory("TECHNOLOGY")));
		add(new Project(
				"DASH 4.0 WALLET",
		...
		add(new Project(
				...
				"http://www.youtube.com/0143534", "Some question text", categoriesRepo
						.getCategory("DESIGN")));
		add(new Project(
				"CUBIT",
				...
				"http://www.youtube.com/0143534",
				"Some question text", categoriesRepo.getCategory("DESIGN")));
		add(new Project(
				"NOKI",
